  ...
  render() {
    return (
      <div className="Faq">
        ...
        <p>
           I accept PayPal and Venmo as payment options. The client will pay an initial payment of 50% of total billed hours. You will pay the other 50% upon completion of your website.
        ...
        <p>The client should expect a small project done in 2-3 months, a medium project done in 3-5 months, and a large project in 6 months or more depending on the project scope. Understand that I'm also working full-time as a web developer, please be patient.</p><br/>
